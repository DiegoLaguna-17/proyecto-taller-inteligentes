...
- Cada PR debe incluir: objetivo, archivos modificados, prueba ejecutada y
evidencia.
...
## Manejo de bloqueos
El bloqueo debe contener como mínimo:
- Qué impide avanzar
- Desde cuándo ocurre
- Qué se intentó
...
- No se ingresan datos personales, secretos ni credenciales.
...
Cada Task/Historia de Usuario debe cumplir los siguientes requerimientos:
